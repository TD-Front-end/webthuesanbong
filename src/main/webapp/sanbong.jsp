                ...
                <div class="col-md-12 col-sm-12">
                    <div class="col-md-7 col-sm-7 col-xs-12">
                        <div class="full">
                            ...
                            <p>Voluptate illum dolore ita ipsum, quid deserunt singulis, labore admodum ita multos malis
                                ea nam nam tamen fore amet.
                            ...
                            <ul class="icon-list">
                                ...
                                <li><i class="fa fa-angle-right"></i> Labore admodum ita multos malis ea nam nam tamen
                                    fore amet
                                </li>
                                <li><i class="fa fa-angle-right"></i> Voluptate illum dolore ita ipsum</li>
                            </ul>
