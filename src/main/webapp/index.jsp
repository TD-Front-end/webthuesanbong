            ...
            <div class="header-top">
                <div class="row">
                    <div class="col-md-6">
                        <div class="full">
                            <div class="logo">
                                <a href="index.jsp"><img src="images/CLMCAhome.jpg" alt="#"/></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="right_top_section">
                            ...
                            <ul class="login">
                                <li class="login-modal">
                                    <a href="Login.jsp" class="login"><i class="fa fa-user"></i>Đăng Nhập</a>
                                </li>
                                <li>
                                    <div class="cart-option">
                                        <a href="register.jsp"><i class="fa fa-shopping-cart"></i>Đăng ký </a>
                                    </div>
                                </li>
                            </ul>
                            <!-- end button section -->
                                    ...
                                    <nav class="navbar navbar-inverse">
                                        ...
                                        <div class="collapse navbar-collapse js-navbar-collapse">
                                            <ul class="nav navbar-nav">
                                                ...
                                                <li><a href="sanbong.jsp">Sân bóng</a></li>
                                                <li><a href="team.html">Liên Hệ</a></li>
                                                <li><a href="news.html">Tin Mới</a></li>
                                                <li class="dropdown mega-dropdown">
                                                    <a href="match" class="dropdown-toggle" data-toggle="dropdown">Sân <span
                                                            class="caret"></span></a>
                                                ...
                                                <li><a href="Registration.jsp">Liên hệ</a></li>
                                            </ul>
                                        </div>
                                        <!-- /.nav-collapse -->
                                    </nav>
                    ...
                    <div class="carousel-caption">
                        ...
                        <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
                            <div class="slider-contant" data-animation="animated fadeInRight">
                                <h3>Nếu như bạn đam mê<br> đá bóng <span class="color-yellow">Đừng chần chừ</span><br>Hãy đặt sân ngay hôm nay!</h3>
                                <p>Đến với sân bóng đá nhân tạo của chúng tôi bạn sẽ được trải nghiệm<br>
                                    bài bản từ hệ thống chiếu sáng đến lưới vây sân bóng đều rất hiện đại, đạt tiêu chuẩn chất lượng.<br>
                                    Hãy đên và trải nghiệm ngay hôm nay.
                                </p>
        ...
        <div class="news">
            <div class="container">
                <div class="heading-slider">
                    <p class="headline"><i class="fa fa-star" aria-hidden="true"></i> Tiêu chí hàng đầu :</p>
                    <!--made by vipul mirajkar thevipulm.appspot.com-->
                    <h1>
                        <a href="" class="typewrite" data-period="2000"
                           data-type='[ "Là đơn vị chuyên nghiệp trong các dịch vụ sân bóng: chúng tôi thi công, đầu tư, vận hành sân bóng đá.","Chúng tôi cũng cung cấp dịch vụ kết nối cộng đồng người chơi thể thao và chủ sân, cũng như đem đến cho khách hàng những dụng cụ và thiết bị thể thao chất lượng nhất."]'>
